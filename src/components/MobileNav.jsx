...
return (
<nav className="lg:hidden bg-slate-200 dark:bg-slate-800 w-full h-14 text-[10px] md:text-xs">
    <motion.ul initial="initial" animate="animate" variants={variants} className='w-full h-full grid grid-cols-7'>
        {navLinks.map((link,i) => (
            ...
            >
                ...
                <span className='uppercase font-semibold'>{link.title ==="certificates"? link.title.slice(0,4):link.title}</span>
            </motion.li>
        ))}     
